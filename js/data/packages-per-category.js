const packages = [
  ...
  //       inclusions: [
  //         "2 Attire Photoshoot",
  //         // "Included Professional Hair and Make-up",
  //         "FREE Use of Available Filipiniana/Toga",
  //         "FREE use of Sablay + UP Medallion (for Uplb Graduates)",
  //         "1 enhanced barkada digital copy",
  //         "FREE Sablay Barkada Shoot",
  //         "All raw shots included",
  //       ],
  //       inclusions2: [
  //         "1 8R Framed Photo",
  //         "5R Photo Print",
  //         "4pcs Wallet Size Print",
  //         "2 enhanced digital copy / person",
  //       ],
  //       calendly_link:
  //         "https://calendly.com/blinkcreativestudio/up-graduation-package-silver-barkada?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
  //     },
  //     {
  //       id: "6-4",
  //       package: "silver-couple",
  //       name: "Silver Couple",
  //       price: "3,200.00",
  //       desc: "You didn’t just graduate, you grew together! Through deadlines, breakdowns, and 3AM cram sessions, you had each other. Now it’s time to celebrate this milestone the way it deserves: side by side, looking your best.",
  //       desc1: "",
  //       desc2:
  //         "Hair and makeup included. Downpayment should not exceed more than 2 days after booking.",
  //       desc3: "",
  ...
  //         "FREE Use of Available Filipiniana/Toga",
  //         "FREE use of Sablay + UP Medallion (for Uplb Graduates)",
  //         "1 enhanced couple digital copy",
  //         "FREE 2R Couple Picture",
  //         "All raw shots included",
  //       ],
  //       inclusions2: [
  //         "1 8R Framed Photo",
  ...
  //       ],
  //       calendly_link:
  //         "https://calendly.com/blinkcreativestudio/up-graduation-package-silver-couple?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
  //     },
  //     {
  //       id: "6-5",
  //       package: "gold",
  ...
  //         "2 8R Framed Photo",
  //         "1 5R Photo Print",
  //         "4pcs Wallet Size Prints Sablay",
  //         "4pcs Wallet Size Prints Toga",
  //         "2 enhanced digital copy / person",
  //       ],
  //       calendly_link:
  //         "https://calendly.com/blinkcreativestudio/up-graduation-package-gold-barkada?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
  //     },
  //     {
  //       id: "6-7",
  //       package: "gold-couple",
  ...
  //       ],
  //       calendly_link:
  //         "https://calendly.com/blinkcreativestudio/up-graduation-package-gold-couple?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
  //     },
  //     {
  //       id: "6-8",
  //       package: "platinum",
    ...
    packages: [
      {
        ...
        desc3: "",
        inclusions: ["1 Lighting Setup", "FREE use of Make up Room"],
        calendly_link:
          "https://calendly.com/blinkcreativestudio/studio-booking?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
      },
      {
        id: "1-2",
        package: "basic-green-screen",
        name: "Basic Green Screen",
        price: "10,000.00",
        desc: "Unlock your creative vision at Blink’s state-of-the-art space! We are equipped with professional-grade equipment, versatile setups, top-notch amenities, and a dedicated team ready to assist you every step of the way. Book today and bring your ideas to life!",
        desc1: "",
        desc2: "Downpayment should not exceed more than 2 days after booking.",
        desc3: "Additional hour PHP 1,600",
        inclusions: [
          "Green Screen Background for 6 hours",
          "Teleprompter/TV",
          "1 Lighting Setup",
        ],
        calendly_link:
          "https://calendly.com/blinkcreativestudio/basic-green-screen?hide_gdpr_banner=1&text_color=191919&primary_color=a30a24",
      },
    ],
  },
  // {
    ...
    packages: [
      ...
      },
      {
        ...
        inclusions: [
          ...
          "1 8R Portrait (Printed and Framed)",
      ...
      },
      {
        ...
        inclusions: [
          ...
          "FREE Digital Copy",
          "4 Wallet Size Prints",
          "2 8R Portrait (Printed and Framed)",
          "2 Enhanced Digital Copies",
        ],
        calendly_link:
      ...
      },
      {
        ...
        inclusions: [
          ...
          "1 12R Portrait (Printed and Framed)",
          "4 Enhanced Digital Copies",
        ],
        calendly_link:
